...
- Simple `task +` / `task -` lines double as an open-tasks list, with optional scheduling (a task can be given a future date and stays hidden from the open list until then)
